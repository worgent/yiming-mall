 ...
 public class FriendsLinkAction
   extends WWAction
 {
   private String id;
   ...
   public String editSave() { if (this.pic != null) {
       if (FileUtil.isAllowUp(this.picFileName)) {
         this.friendsLink.setLogo(UploadUtil.upload(this.pic, this.picFileName, "friendslink"));
       } else {
         this.msgs.add("不允许上传的文件格式，请上传gif,jpg,bmp格式文件。");
   ...
   public void setFriendsLink(FriendsLink friendsLink) { this.friendsLink = friendsLink; }

   public IFriendsLinkManager getFriendsLinkManager() {
     return this.friendsLinkManager;
   }

   public void setFriendsLinkManager(IFriendsLinkManager friendsLinkManager) { this.friendsLinkManager = friendsLinkManager; }

   public List getListLink() {
     return this.listLink;
   }

   public void setListLink(List listLink) { this.listLink = listLink; }
...
/* Location:              C:\Users\worgen\Desktop\临时\javashop_b2b2c.war!\WEB-INF\lib\component-eop.jar!\com\enation\app\base\core\action\FriendsLinkAction.class
