   ...
   extends WWAction
 {
     ...
     throws Exception
   {
     ...
     this.themeinfo = this.themeManager.getTheme(site.getThemeid());
     this.listTheme = this.themeManager.list();
     this.previewpath = (this.previewBasePath + this.themeinfo.getPath() + "/preview.png");
     return "success";
   }
   ...
   public Theme getThemeinfo() { return this.themeinfo; }
...
/* Location:              C:\Users\worgen\Desktop\临时\javashop_b2b2c.war!\WEB-INF\lib\component-eop.jar!\com\enation\app\base\core\action\SiteThemeAction.class
