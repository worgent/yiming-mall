   ...
   extends WWAction
 {
   ...
   public String backup()
   {
     try
     {
       this.name = ("backup_" + DateUtil.getDatelineLong());
   ...
   public String restore()
   {
     try
     {
       String productid = "temp_" + DateUtil.getDatelineLong();
   ...
   public String initData()
   {
     try
     {
       ...
       if (!this.vcode.equalsIgnoreCase((String)realCode)) {
     ...
     throws Exception
   {
     ...
     try {
       if (!StringUtil.isEmpty(this.logopath)) {
         this.logopath = this.logopath.replaceAll(EopSetting.IMG_SERVER_DOMAIN + EopContext.getContext().getContextPath(), EopSetting.FILE_STORE_PREFIX);
         this.eopSite.setLogofile(this.logopath);
         this.eopSite.setBklogofile(this.logopath);
       }
       if (!StringUtil.isEmpty(this.iconpath)) {
         this.iconpath = this.iconpath.replaceAll(EopSetting.IMG_SERVER_DOMAIN + EopContext.getContext().getContextPath(), EopSetting.FILE_STORE_PREFIX);
         this.eopSite.setIcofile(this.iconpath);
       }
...
/* Location:              C:\Users\worgen\Desktop\临时\javashop_b2b2c.war!\WEB-INF\lib\component-eop.jar!\com\enation\app\base\core\action\UserSiteAction.class
