 ...
 public class ProfileCreator
 {
   ...
   public void createProfile(String path)
   {
     ...
     fillCommponentElement(componentItemEl);
   ...
   {
     List<ThemeUri> uriList = this.themeUriManager.list(null);
   ...
   {
     List<Menu> menuTree = this.menuManager.getMenuTree(Integer.valueOf(0));
...
/* Location:              C:\Users\worgen\Desktop\临时\javashop_b2b2c.war!\WEB-INF\lib\component-eop.jar!\com\enation\app\base\core\service\solution\impl\ProfileCreator.class
