 ...
 public class AuthActionManager
   extends BaseSupport<AuthAction>
   implements IAuthActionManager
 {
   ...
   public List<AuthAction> list() {
     return this.baseDaoSupport.queryForList("select * from auth_action where actid!=0", AuthAction.class, new Object[0]);
   }
   ...
   {
     List<AuthAction> list = this.baseDaoSupport.queryForList("select * from auth_action where actid=?", AuthAction.class, new Object[] { Integer.valueOf(authid) });
...
/* Location:              C:\Users\worgen\Desktop\临时\javashop_b2b2c.war!\WEB-INF\lib\component-eop.jar!\com\enation\app\base\core\service\auth\impl\AuthActionManager.class
