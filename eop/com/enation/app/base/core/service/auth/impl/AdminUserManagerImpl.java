   ...
   implements IAdminUserManager
 {
   ...
   public int loginBySys(String username, String password)
   {
     ...
     List<AdminUser> userList = this.baseDaoSupport.queryForList(sql, AdminUser.class, new Object[] { username });
     ...
     List<AuthAction> authList = this.permissionManager.getUesrAct(user.getUserid().intValue());
...
/* Location:              C:\Users\worgen\Desktop\临时\javashop_b2b2c.war!\WEB-INF\lib\component-eop.jar!\com\enation\app\base\core\service\auth\impl\AdminUserManagerImpl.class
