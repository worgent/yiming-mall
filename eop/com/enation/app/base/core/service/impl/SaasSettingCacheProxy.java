   ...
   implements ISettingService
 {
   ...
   public void add(String groupname, String name, String value)
   {
     ...
     Map<String, Map<String, String>> settings = (Map)this.cache.get(uKey);
   ...
   public Map<String, Map<String, String>> getSetting()
   {
     ...
     if ("2".equals(EopSetting.RUNMODE)) {
       userid = getCurrentUserid().intValue();
       siteid = getCurrentSiteid().intValue();
     }
   ...
   {
     Map<String, Map<String, String>> settings = getSetting();
     if (settings == null) { return null;
     }
     Map<String, String> setting = (Map)settings.get(group);
...
/* Location:              C:\Users\worgen\Desktop\临时\javashop_b2b2c.war!\WEB-INF\lib\component-eop.jar!\com\enation\app\base\core\service\impl\SaasSettingCacheProxy.class
