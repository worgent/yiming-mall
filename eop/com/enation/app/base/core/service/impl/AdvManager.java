   ...
   implements IAdvManager
 {
   ...
   public List listAdv(Long acid)
   {
     ...
     List<Adv> list = this.baseDaoSupport.queryForList("select a.*,'' cname from adv a where acid = ? and isclose = 0", new AdvMapper(), new Object[] { acid });
     return list;
   }
...
/* Location:              C:\Users\worgen\Desktop\临时\javashop_b2b2c.war!\WEB-INF\lib\component-eop.jar!\com\enation\app\base\core\service\impl\AdvManager.class
