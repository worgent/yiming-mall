   ...
   implements ISettingService
 {
   ...
   public Map<String, Map<String, String>> getSetting()
   {
     ...
     List<Map<String, String>> list = this.baseDaoSupport.queryForList(sql, new Object[0]);
...
/* Location:              C:\Users\worgen\Desktop\临时\javashop_b2b2c.war!\WEB-INF\lib\component-eop.jar!\com\enation\app\base\core\service\impl\SaasSettingService.class
