 ...
 public class BorderManagerImpl
   extends BaseSupport<Border>
   implements IBorderManager
 {
   ...
   public List<Border> list() {
     ...
     List<Border> list = this.baseDaoSupport.queryForList(sql, Border.class, new Object[0]);
     return list;
   }
...
/* Location:              C:\Users\worgen\Desktop\临时\javashop_b2b2c.war!\WEB-INF\lib\component-eop.jar!\com\enation\eop\resource\impl\BorderManagerImpl.class
