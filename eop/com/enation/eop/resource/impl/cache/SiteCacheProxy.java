 ...
 public class SiteCacheProxy
   extends AbstractCacheProxy<EopSite>
   implements ISiteManager
 {
   ...
   public Page list(String keyword, int sitestate, int pageNo, int pageSize) {
     Page page = this.siteManager.list(keyword, sitestate, pageNo, pageSize);
     List<Map> listsite = (List)page.getResult();

     List<Dns> dnsList = getDnsList();
     for (Map site : listsite) {
       List<Dns> domainList = new ArrayList();
...
/* Location:              C:\Users\worgen\Desktop\临时\javashop_b2b2c.war!\WEB-INF\lib\component-eop.jar!\com\enation\eop\resource\impl\cache\SiteCacheProxy.class
