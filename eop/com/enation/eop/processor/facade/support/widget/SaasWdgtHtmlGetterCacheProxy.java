 ...
 public class SaasWdgtHtmlGetterCacheProxy
   extends AbstractCacheProxy<Map<String, String>>
   implements IWidgetHtmlGetter
 {
   ...
   public String process(Map<String, String> params, String pageUri)
   {
     ...
     if ((getCacheOpen()) && (widget.cacheAble()))
     {
       ...
       Map<String, String> htmlCache = (Map)this.cache.get(site_key);
...
/* Location:              C:\Users\worgen\Desktop\临时\javashop_b2b2c.war!\WEB-INF\lib\component-eop.jar!\com\enation\eop\processor\facade\support\widget\SaasWdgtHtmlGetterCacheProxy.class
