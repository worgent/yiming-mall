   ...
   public String doPase(String uri) {
     ...
     if (widgets != null)
     {
       ...
       if (("yes".equals(ajax)) && (!StringUtil.isEmpty(widgetid))) {
         Map<String, String> wgtParams = (Map)widgets.get(widgetid);
     ...
     Map<String, Map<String, String>> commonWidgets;
     if (!"yes".equals(ajax))
     {
...
/* Location:              C:\Users\worgen\Desktop\临时\javashop_b2b2c.war!\WEB-INF\lib\component-eop.jar!\com\enation\eop\processor\facade\support\FacadePagePaser.class
