   ...
   implements IPageParamJsonGetter
 {
   ...
   public String getJson(String uri)
   {
     ...
     Map<String, Map<String, String>> params = (Map)pages.get(uri);
...
/* Location:              C:\Users\worgen\Desktop\临时\javashop_b2b2c.war!\WEB-INF\lib\component-eop.jar!\com\enation\eop\processor\facade\support\PageParamJsonGetter.class
