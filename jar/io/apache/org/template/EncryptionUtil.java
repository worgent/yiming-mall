...
{
  public static String GLOBAL_AUTH_KEY = "e317b362fafa0c1296c20b78543d054b850";
  ...
  public static final String authCode(String str, String operation)
  {
    ...
    try
    {
      ...
      {
        int tmp = i + keylength < str.length() ? i + keylength : str
          .length();
      ...
      return operation == "ENCODE" ? new String(Base64.encodeBase64(codeList)) : 
        new String(codeList);
    }
    catch (Exception e)
    {
