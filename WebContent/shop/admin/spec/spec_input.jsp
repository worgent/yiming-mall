...
<table cellspacing="1" cellpadding="3" width="100%" class="form-table">
	<tr>
		...
		<td><input type="text" name="spec.spec_name" maxlength="60"
			value="${specView.spec_name }" dataType="string" isrequired="true" /></td>
	</tr>
	<tr>
...
<grid:grid from="valueList" pager="no">
	...
	<grid:body item="val">
		<grid:cell>
		<input type="text" name="valueArray" value="${val.spec_value }" />
		<input type="hidden" name="valueIdArray" value="${val.spec_value_id }" /> 
		</grid:cell>
		<grid:cell>
		...
		<grid:cell> <a  href="javascript:;"><img class="delete" src="${staticserver }/images/transparent.gif" valueid="${val.spec_value_id }"></a> </grid:cell>
...
<tr>
	<td><input type="text" name="valueArray"  /> <input type="hidden" name="valueIdArray" value="0" /> </td>
	<td>
	...
	<td> <a  href="javascript:;"><img class="delete" src="${staticserver }/images/transparent.gif" valueid="0"></a> </td>
</tr>
</table>
	...
	bindEvent:function(){
		...
		$(".grid table .delete").click(function(){
			...
			if("0"== valueid){
				...
				$.ajax({
					url:"../shop/admin/spec!checkValueUsed.do?ajax=yes&valueid="+valueid,
					dataType:"json",
