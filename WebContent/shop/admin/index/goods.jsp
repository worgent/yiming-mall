...
<table cellspacing="0" cellpadding="0" border="0" width="100%">
      <tbody>      
          <tr>
            ...
            <td><span ><a <c:if test="${goodsss.allcount > 0 }"> href="${ctx }/shop/admin/goods!list.do"  class="imp"</c:if>>${ goodsss.allcount}</a>个</span></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><span ><a <c:if test="${goodsss.salecount > 0 }"> href="${ctx }/shop/admin/goods!list.do?market_enable=1"   class="imp"</c:if>>${ goodsss.salecount}</a>个</span></td>
          </tr>
          <tr>
            <th><span>下架商品：</span></th>
            <td><span><a <c:if test="${goodsss.unsalecount> 0 }"> href="${ctx }/shop/admin/goods!list.do?market_enable=0"  class="imp"</c:if>>${ goodsss.unsalecount}</a>个</span></td>
          </tr>
          <tr>
