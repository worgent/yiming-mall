   ...
   public String select_condition()
   {
     try
     {
       ...
       if (this.pmtid != null) {
         ...
         int i = 0; MemberLv lv; for (int len = this.lvList.size(); i < len; i++) {
...
/* Location:              C:\Users\worgen\Desktop\临时\javashop_b2b2c.war!\WEB-INF\lib\component-shop.jar!\com\enation\app\shop\core\action\backend\PromotionAction.class
