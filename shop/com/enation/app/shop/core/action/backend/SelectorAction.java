   ...
   extends WWAction
 {
   ...
   public String goods()
   {
     ...
     this.goodsMap.put("name", name);
     this.goodsMap.put("sn", sn);
     this.goodsMap.put("order", this.order);

     this.webpage = this.goodsManager.searchGoods(this.goodsMap, getPage(), 5, null, getSort(), getOrder());
     return "goods";
   }
...
/* Location:              C:\Users\worgen\Desktop\临时\javashop_b2b2c.war!\WEB-INF\lib\component-shop.jar!\com\enation\app\shop\core\action\backend\SelectorAction.class
