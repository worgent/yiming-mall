 ...
 public class PaymentAction extends WWAction
 {
   ...
   private com.enation.app.base.core.service.auth.IAdminUserManager adminUserManager;
   private Order ord;
   ...
   public String showPayDialog()
   {
     ...
     try {
       this.payment_id = this.orderReportManager.getPaymentLogId(this.orderId).intValue();
       this.payment = this.orderReportManager.getPayment(Integer.valueOf(this.payment_id));
       this.paymentList = this.orderReportManager.listPayMentDetail(Integer.valueOf(this.payment_id));
       this.metaList = this.orderMetaManager.list(this.ord.getOrder_id().intValue());
       this.showMoney = Double.valueOf(CurrencyUtil.sub(this.payment.getMoney().doubleValue(), this.payment.getPaymoney().doubleValue()));
     }
     catch (Exception e) {
       e.printStackTrace();
     }
   ...
   public String pay()
   {
     try
     {
       ...
       if (this.orderFlowManager.pay(Integer.valueOf(this.payment_id), this.orderId, this.paymoney.doubleValue(), username)) {
...
/* Location:              C:\Users\worgen\Desktop\临时\javashop_b2b2c.war!\WEB-INF\lib\component-shop.jar!\com\enation\app\shop\core\action\backend\PaymentAction.class
