 ...
 @Action("area")
 @Results({@org.apache.struts2.convention.annotation.Result(name="add_area", location="/shop/admin/setting/area_add.jsp"), @org.apache.struts2.convention.annotation.Result(name="edit_area", location="/shop/admin/setting/area_edit.jsp"), @org.apache.struts2.convention.annotation.Result(name="list_area", location="/shop/admin/setting/area_list.jsp"), @org.apache.struts2.convention.annotation.Result(name="list_regions", type="freemarker", location="/shop/admin/setting/site_area.html")})
   ...
   extends WWAction
 {
   ...
   public String listChildren() {
     String s = this.regionsManager.getChildrenJson(this.regionid);
     this.json = s.replace("local_name", "text").replace("p_region_id", "id");
     return "json_message";
   }

   public String getRegionsList() {
     this.regionList = this.regionsManager.listChildren(this.regionid);
     return "list_regions";
   }
...
/* Location:              C:\Users\worgen\Desktop\临时\javashop_b2b2c.war!\WEB-INF\lib\component-shop.jar!\com\enation\app\shop\core\action\backend\AreaAction.class
