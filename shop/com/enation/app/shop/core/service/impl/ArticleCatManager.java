   ...
   implements IArticleCatManager
 {
   ...
   private List<ArticleCat> getChildren(List<ArticleCat> catList, Integer parentid) {
     ...
     List<ArticleCat> children = new ArrayList();
   ...
   public List listHelp(int cat_id)
   {
     ...
     for (Map map : list) {
       List<Article> articleList = this.articleManager.listByCatId(Integer.valueOf(map.get("cat_id").toString()));
...
/* Location:              C:\Users\worgen\Desktop\临时\javashop_b2b2c.war!\WEB-INF\lib\component-shop.jar!\com\enation\app\shop\core\service\impl\ArticleCatManager.class
