   ...
   implements IPaymentManager
 {
   ...
   public Integer add(String name, String type, String biref, Map<String, String> configParmas)
   {
     ...
     Integer id = Integer.valueOf(this.baseDaoSupport.getLastId("payment_cfg"));
     return id;
   }
   ...
   public String getPluginInstallHtml(String pluginId, Integer paymentId)
   {
     ...
     if (paymentId != null) {
       Map<String, String> params = getConfigParams(paymentId);
...
/* Location:              C:\Users\worgen\Desktop\临时\javashop_b2b2c.war!\WEB-INF\lib\component-shop.jar!\com\enation\app\shop\core\service\impl\PaymentManager.class
