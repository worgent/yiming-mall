 ...
 public class GoodsTagManager extends BaseSupport<Goods> implements IGoodsTagManager
 {
   ...
   {
     StringBuffer sql = new StringBuffer();
     sql.append("select g.goods_id,g.name,r.tag_id,r.ordernum,g.thumbnail,g.price from " + getTableName("tag_rel") + " r LEFT JOIN " + getTableName("goods") + " g ON g.goods_id=r.rel_id where g.disabled=0 and g.market_enable=1");
     sql.append(" and r.tag_id = ?");
     sql.append(" order by r.ordernum desc");
     System.out.println(sql.toString());
     List list = this.baseDaoSupport.queryForList(sql.toString(), new Object[] { Integer.valueOf(tagid) });
     return list;
   }
 }


/* Location:              C:\Users\worgen\Desktop\临时\javashop_b2b2c.war!\WEB-INF\lib\component-shop.jar!\com\enation\app\shop\core\service\impl\GoodsTagManager.class
