 ...
 public class GoodsImageReader
 {
   ...
   private String getSettingValue(String code) { return this.settingService.getSetting("photo", code); }
   ...
   private String getThumbPath(String filename, String shortName, String goodsid) { String name = UploadUtil.getThumbPath(filename, shortName);
   ...
   public ISettingService getSettingService() { return this.settingService; }
...
/* Location:              C:\Users\worgen\Desktop\临时\javashop_b2b2c.war!\WEB-INF\lib\component-shop.jar!\com\enation\app\shop\core\service\impl\batchimport\\util\GoodsImageReader.class
