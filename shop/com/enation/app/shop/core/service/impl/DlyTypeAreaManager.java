 ...
 public class DlyTypeAreaManager
   extends BaseSupport
   implements IDlyTypeAreaManager
 {
   ...
   public Map queryOtherRegions(Integer type_id, String regionid)
   {
     ...
     List<Map> typeAreaList = this.baseDaoSupport.queryForList(sql, new RowMapper()
     {
       public Object mapRow(ResultSet rs, int arg1) throws SQLException
       {
         Map map = new HashMap();
...
/* Location:              C:\Users\worgen\Desktop\临时\javashop_b2b2c.war!\WEB-INF\lib\component-shop.jar!\com\enation\app\shop\core\service\impl\DlyTypeAreaManager.class
