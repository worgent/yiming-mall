   ...
   implements IGnotifyManager
 {
   public Page pageGnotify(int pageNo, int pageSize)
   {
     ...
     String sql = "select a.*,b.sn, b.thumbnail image,b.store store, b.name name, b.price price, b.mktprice mktprice,b.cat_id cat_id from " + getTableName("gnotify") + " a inner join " + getTableName("goods") + " b on b.goods_id = a.goods_id ";
...
/* Location:              C:\Users\worgen\Desktop\临时\javashop_b2b2c.war!\WEB-INF\lib\component-shop.jar!\com\enation\app\shop\core\service\impl\GnotifyManager.class
