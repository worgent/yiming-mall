...
import org.springframework.jdbc.core.simple.SimpleJdbcTemplate;
   ...
   implements IGoodsTypeManager
 {
   ...
   {
     String sql = "select * from goods_type where disabled=0 and have_parm=1 and type_id=" + type_id;
   ...
   public Integer save(GoodsType type)
   {
     ...
     if (type.getType_id() != null) {
       ...
       if (logger.isDebugEnabled()) {
         logger.debug("增加商品类型成功 , id is " + type_id);
       }
     }
   ...
   private List<ParamGroup> toParamList(String[] ar_paramnum, String[] groupnames, String[] paramnames, String[] paramvalues)
   {
     ...
     if (groupnames != null) {
       for (int i = 0; i < groupnames.length; i++) {
         ...
         List<GoodsParam> paramList = getParamList(ar_paramnum, paramnames, paramvalues, i);
   ...
   public void setSimpleJdbcTemplate(SimpleJdbcTemplate simpleJdbcTemplate) { this.simpleJdbcTemplate = simpleJdbcTemplate; }
...
/* Location:              C:\Users\worgen\Desktop\临时\javashop_b2b2c.war!\WEB-INF\lib\component-shop.jar!\com\enation\app\shop\core\service\impl\GoodsTypeManager.class
