 ...
 public class MemberLvManager
   extends BaseSupport<MemberLv>
   implements IMemberLvManager
 {
   public void add(MemberLv lv)
   {
     if (lv.getDefault_lv().intValue() == 1) {
       this.baseDaoSupport.execute("update es_member_lv m set m.default_lv=0", new Object[0]);
     }
   ...
   public Integer getDefaultLv()
   {
     ...
     List<MemberLv> lvList = this.baseDaoSupport.queryForList(sql, MemberLv.class, new Object[0]);
   ...
   public MemberLv getByPoint(int point)
   {
     ...
     List<MemberLv> list = this.baseDaoSupport.queryForList(sql, MemberLv.class, new Object[] { Integer.valueOf(point) });
...
/* Location:              C:\Users\worgen\Desktop\临时\javashop_b2b2c.war!\WEB-INF\lib\component-shop.jar!\com\enation\app\shop\core\service\impl\MemberLvManager.class
