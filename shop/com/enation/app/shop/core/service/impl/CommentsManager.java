   ...
   implements ICommentsManager
 {
   ...
   public CommentDTO getComments(Integer commentId)
   {
     ...
     List<Comments> list = this.baseDaoSupport.queryForList("select * from comments where for_comment_id = ? order by time desc", Comments.class, new Object[] { commentId });
...
/* Location:              C:\Users\worgen\Desktop\临时\javashop_b2b2c.war!\WEB-INF\lib\component-shop.jar!\com\enation\app\shop\core\service\impl\CommentsManager.class
