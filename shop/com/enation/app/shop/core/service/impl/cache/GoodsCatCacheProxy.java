 ...
 public class GoodsCatCacheProxy
   extends AbstractCacheProxy<List<Cat>>
   implements IGoodsCatManager
 {
   ...
   {
     EopSite site = EopContext.getContext().getCurrentSite();
     List<Cat> catList = (List)this.cache.get("goods_cat_" + site.getUserid() + "_" + site.getId() + "_" + catId);
     if (catList == null) {
...
/* Location:              C:\Users\worgen\Desktop\临时\javashop_b2b2c.war!\WEB-INF\lib\component-shop.jar!\com\enation\app\shop\core\service\impl\cache\GoodsCatCacheProxy.class
