 ...
 public class MemberPointManger
   extends BaseSupport
   implements IMemberPointManger
 {
   ...
   public void thaw(Integer orderId)
   {
     ...
     if ((order.getStatus() == null) || ((order.getStatus().intValue() != 6) && (order.getStatus().intValue() != 7))) {
     ...
     for (FreezePoint fp : list)
     {
       ...
       if ((fp.getOrder_status() == 6) || (order.getStatus().intValue() == 7)) {
         thaw(fp, true);
       }
     }
...
/* Location:              C:\Users\worgen\Desktop\临时\javashop_b2b2c.war!\WEB-INF\lib\component-shop.jar!\com\enation\app\shop\core\service\impl\MemberPointManger.class
