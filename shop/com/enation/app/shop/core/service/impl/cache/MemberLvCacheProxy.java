 ...
 public class MemberLvCacheProxy
   extends AbstractCacheProxy<List<MemberLv>>
   implements IMemberLvManager
 {
   ...
   private void cleanCache() {
     ...
     this.cache.remove("member_lv_" + site.getUserid() + "_" + site.getId());
   }
   ...
   {
     EopSite site = EopContext.getContext().getCurrentSite();
     List<MemberLv> memberLvList = (List)this.cache.get("member_lv_" + site.getUserid() + "_" + site.getId());
...
/* Location:              C:\Users\worgen\Desktop\临时\javashop_b2b2c.war!\WEB-INF\lib\component-shop.jar!\com\enation\app\shop\core\service\impl\cache\MemberLvCacheProxy.class
