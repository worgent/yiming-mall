   ...
   implements Serializable
 {
   ...
   public void setHave_parm(int have_parm) { this.have_parm = have_parm; }

   public int getHave_prop() {
     return this.have_prop;
   }

   public void setHave_prop(int have_prop) { this.have_prop = have_prop; }

   public int getIs_physical() {
     return this.is_physical;
   }

   public void setIs_physical(int is_physical) { this.is_physical = is_physical; }

   public int getJoin_brand() {
     return this.join_brand;
   }

   public void setJoin_brand(int join_brand) { this.join_brand = join_brand; }
   ...
   public void setBrand_ids(Integer[] brand_ids) { this.brand_ids = brand_ids; }

   public int getHave_field() {
     return this.have_field;
   }

   public void setHave_field(int haveField) { this.have_field = haveField; }
 }


/* Location:              C:\Users\worgen\Desktop\临时\javashop_b2b2c.war!\WEB-INF\lib\component-shop.jar!\com\enation\app\shop\core\model\GoodsType.class
