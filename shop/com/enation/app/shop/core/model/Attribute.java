 ...
 public class Attribute
 {
   ...
   public Attribute() { this.valueList = new ArrayList();
     this.hidden = 0;
   }
     ...
     if (this.type >= 3)
     {
       if ((this.type >= 3) && (this.type <= 5)) {
         ...
         if ((this.value != null) && (!this.value.equals("")) && (!this.value.equals("null"))) {
           ...
           String result = "";
           for (String id : ids) {
             if (!StringUtil.isEmpty(result)) result = result + ",";
             result = result + getOptionAr()[StringUtil.toInt(id, false)];
           }
           return result; }
         return null;
       }
...
/* Location:              C:\Users\worgen\Desktop\临时\javashop_b2b2c.war!\WEB-INF\lib\component-shop.jar!\com\enation\app\shop\core\model\Attribute.class
