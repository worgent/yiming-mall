   ...
   implements Serializable
 {
   ...
   public void setChange_goods_name(String change_goods_name) { this.change_goods_name = change_goods_name; }

   public Integer getChange_goods_id() {
     return this.change_goods_id;
   }

   public void setChange_goods_id(Integer change_goods_id) { this.change_goods_id = change_goods_id; }
   ...
   public void setGainedpoint(int gainedpoint) { this.gainedpoint = gainedpoint; }
   ...
   public void setCat_id(int cat_id) { this.cat_id = Integer.valueOf(cat_id); }
...
/* Location:              C:\Users\worgen\Desktop\临时\javashop_b2b2c.war!\WEB-INF\lib\component-shop.jar!\com\enation\app\shop\core\model\OrderItem.class
