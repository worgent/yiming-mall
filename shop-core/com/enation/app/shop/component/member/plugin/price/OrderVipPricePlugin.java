 ...
 @Component
 public class OrderVipPricePlugin
   ...
   implements ICartItemFilter
 {
   ...
   private void applyMemPrice(List<CartItem> itemList, List<GoodsLvPrice> memPriceList, double discount)
   {
     for (CartItem item : itemList) {
       ...
       if (item.getCoupPrice() == null) { item.setCoupPrice(item.getPrice());
       } else if (item.getCoupPrice().doubleValue() >= oldprice) {
...
/* Location:              C:\Users\worgen\Desktop\临时\javashop_b2b2c.war!\WEB-INF\lib\component-shop-core.jar!\com\enation\app\shop\component\member\plugin\price\OrderVipPricePlugin.class
